 ...
 * `phone`, `document`) refletem em todas as empresas; dados do vínculo
 * (`type`, `is_active`) afetam só a empresa da sessão. Senha nunca é editada
 * por PATCH — há fluxo próprio (troca de senha).
 */
